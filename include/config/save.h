...
#define FREE_EXTRA_SEEN_FLAGS_SAVEBLOCK1    TRUE   // Libera las flags de Pokédex vistas no utilizadas (52 bytes).
#define FREE_TRAINER_HILL                   FALSE   // Libera los datos de Trainer Hill (28 bytes).
#define FREE_MYSTERY_EVENT_BUFFERS          TRUE   // Libera el espacio de ramScript (1104 bytes).
#define FREE_MATCH_CALL                     FALSE   // Libera los datos de llamadas de batalla y rematches / buscador VS. (104 bytes).
#define FREE_UNION_ROOM_CHAT                TRUE   // Libera el chat de la sala de unión (212 bytes).
...
#define FREE_MYSTERY_GIFT                   TRUE   // Libera los datos de Regalo Misterioso (876 bytes).
                                            // Total de SaveBlock1: 2516 bytes
// Configuraciones de SaveBlock2
#define FREE_BATTLE_TOWER_E_READER          TRUE   // Libera los datos del E-Reader de Battle Tower (188 bytes).
#define FREE_POKEMON_JUMP                   TRUE   // Libera los datos de Pokémon Jump (16 bytes).
#define FREE_RECORD_MIXING_HALL_RECORDS     FALSE   // Libera los récords de la sala de mezclado de récords (1032 bytes).
#define FREE_EXTRA_SEEN_FLAGS_SAVEBLOCK2    TRUE   // Libera las flags de Pokédex vistas no utilizadas (108 bytes).
