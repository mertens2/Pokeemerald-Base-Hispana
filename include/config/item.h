...
#define I_SELL_VALUE_FRACTION           GEN_7       // En Gen9+, los objetos se venden por 1/4 de su valor en lugar de 1/2.
...
#define I_ORAS_DOWSING_FLAG         FLAG_SYS_ORAS_DOWNSING           // Replace 0 with an unused flag to enable the Dowsing Machine mechanic from ORAS.
