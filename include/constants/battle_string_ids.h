...
enum StringID
{
    ...
    STRINGID_TERRAINBECOMESTHUNDER,
    ...
    STRINGID_THUNDERTERRAINPREVENTS,
    ...
    STRINGID_SCREENCLEANERREFLECTENTERS,
    ...
    STRINGID_THUNDERCURRENTISRUNNING,
    STRINGID_SEEMSWEIRD,
    ...
    STRINGID_TARGETISMALLNOW,
    STRINGID_FIELDTHUNDERTERRAINSTATSRESET,
    STRINGID_COUNT
};
...
enum SwitchInAbilityStringID
{
    ...
    B_MSG_SWITCHIN_SCREENCLEANERREFLECT,
...
{
    B_MSG_SET_TRICK_ROOM = (B_MSG_TERRAIN_SET_THUNDER + 1),
