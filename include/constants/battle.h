...
#define STATUS_FIELD_THUNDER_TERRAIN                (1 << 10)
#define STATUS_FIELD_ION_DELUGE                     (1 << 11)
#define STATUS_FIELD_FAIRY_LOCK                     (1 << 12)
#define STATUS_FIELD_DEBUFF_ROOM                    (1 << 13)

#define STATUS_FIELD_TERRAIN_ANY        (STATUS_FIELD_GRASSY_TERRAIN | STATUS_FIELD_MISTY_TERRAIN | STATUS_FIELD_ELECTRIC_TERRAIN | STATUS_FIELD_PSYCHIC_TERRAIN | STATUS_FIELD_THUNDER_TERRAIN)
...
enum StartingStatus
{
    ...
    STARTING_STATUS_THUNDER_TERRAIN,
