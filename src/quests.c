...
static const u8 sText_AllHeader[] = _("Todas");
static const u8 sText_InactiveHeader[] = _("Misiones Inactivas");
static const u8 sText_ActiveHeader[] = _("Misiones Activas");
static const u8 sText_RewardHeader[] = _("¡Hay Recompensa!");
static const u8 sText_CompletedHeader[] =
      _("Misiones Completas");
static const u8 sText_QuestNumberDisplay[] =
      _("{STR_VAR_1}/{STR_VAR_2}");
static const u8 sText_Unk[] = _("??????");
static const u8 sText_Active[] = _("Activa");
static const u8 sText_Reward[] = _("Recompensa");
static const u8 sText_Complete[] = _("Hecha");
static const u8 sText_ShowLocation[] =
      _("Lugar: {STR_VAR_2}");
static const u8 sText_StartForMore[] =
      _("Start para detalles.");
static const u8 sText_ReturnRecieveReward[] =
      _("¡Vuelve a {STR_VAR_2}\npara recibir tu recompensa!");
static const u8 sText_SubQuestButton[] = _(" {A_BUTTON}");
static const u8 sText_Type[] = _("{R_BUTTON}Tipo");
static const u8 sText_Caught[] = _("Atrapado");
static const u8 sText_Found[] = _("Encontrado");
static const u8 sText_Read[] = _("Leer");
static const u8 sText_Back[] = _("Volver");
static const u8 sText_DotSpace[] = _(". ");
static const u8 sText_Close[] = _("Cerrar");
...
static void QuestMenu_CreateSprite(u16 itemId, u8 idx, u8 spriteType)
{
	...
	if (ptr[idx] == MAX_SPRITES-1)
	{
		...
		switch (spriteType)
		{
			...
			case PKMN:
				LoadMonIconPalettes();
				spriteId = CreateMonIcon(itemId, SpriteCallbackDummy, 20, 132, 0, 32);
				break;
			default:
				break;
		}
