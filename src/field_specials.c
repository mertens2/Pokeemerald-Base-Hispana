...
u32 GetMartEmployeeObjectEventId(void)
{
    static const u8 sPokeMarts[][3] =
    {
        ...
        { MAP_GROUP(MAP_VERDANTURF_TOWN_POKEMON_CENTER_1F),  			MAP_NUM(MAP_VERDANTURF_TOWN_POKEMON_CENTER_1F), LOCALID_VERDANTURF_MART_CLERK },
        { MAP_GROUP(MAP_PETALBURG_CITY_POKEMON_CENTER_1F),   			MAP_NUM(MAP_PETALBURG_CITY_POKEMON_CENTER_1F),  LOCALID_PETALBURG_MART_CLERK },
        { MAP_GROUP(MAP_DEWFORD_TOWN_POKEMON_CENTER_1F),     			MAP_NUM(MAP_PETALBURG_CITY_POKEMON_CENTER_1F),  LOCALID_DEWFORD_MART_CLERK },
        { MAP_GROUP(MAP_SLATEPORT_CITY_POKEMON_CENTER_1F),   			MAP_NUM(MAP_SLATEPORT_CITY_POKEMON_CENTER_1F),  LOCALID_SLATEPORT_MART_CLERK },
        { MAP_GROUP(MAP_MAUVILLE_CITY_POKEMON_CENTER_1F),               MAP_NUM(MAP_MAUVILLE_CITY_POKEMON_CENTER_1F),   LOCALID_MAUVILLE_MART_CLERK },
        { MAP_GROUP(MAP_RUSTBORO_CITY_POKEMON_CENTER_1F),   			MAP_NUM(MAP_RUSTBORO_CITY_POKEMON_CENTER_1F),   LOCALID_RUSTBORO_MART_CLERK },
