...
static const u8 sText_LegendaryPkmnAppeared[] = _("¡Woah! ¡Es un {B_OPPONENT_MON1_NAME} salvaje!\p");
static const u8 sText_WildPkmnAppearedPause[] = _("¡Un {B_OPPONENT_MON1_NAME} salvaje te desafía!{PAUSE 127}");
...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PKMNFLINCHED]                         = COMPOUND_STRING("¡{B_ATK_NAME_WITH_PREFIX} se atemorizó!"),
    ...
    [STRINGID_TRAINERBLOCKEDBALL]                   = COMPOUND_STRING("¡El seguro de tu Poké Ball no se activó!"),
    ...
    [STRINGID_PKMNBROKEFREE]                        = COMPOUND_STRING("¡El Pokémon se escapó!"),
    ...
    [STRINGID_PKMNSXPREVENTSFLINCHING]              = COMPOUND_STRING("¡{B_EFF_ABILITY} de {B_EFF_NAME_WITH_PREFIX}\nle impide atemorizarse!"), //En gen 5+, no hay popup de habilidad
    ...
    [STRINGID_THUNDERTERRAINENDS]                   = COMPOUND_STRING("Los truenos ya no golpean la tierra."),
    ...
    [STRINGID_MOLDBREAKERENTERS]                    = COMPOUND_STRING("¡{B_SCR_NAME_WITH_PREFIX} está rompiendo el molde!"),
    ...
    [STRINGID_SLOWSTARTENTERS]                      = COMPOUND_STRING("¡{B_SCR_NAME_WITH_PREFIX} lo está dando todo!"),
    [STRINGID_SLOWSTARTEND]                         = COMPOUND_STRING("¡{B_ATK_NAME_WITH_PREFIX} recuperó su poder de antaño!"),
    ...
    [STRINGID_THUNDERTERRAINPREVENTS]               = COMPOUND_STRING("¡El campo trueno ha protegido a {B_DEF_NAME_WITH_PREFIX}!"),
    ...
    [STRINGID_SCREENCLEANERENTERS]                  = COMPOUND_STRING("¡Ha aparecido una Pantalla de Luz!"),
    [STRINGID_SCREENCLEANERREFLECTENTERS]           = COMPOUND_STRING("¡Ha aparecido un Reflejo!"),
    ...
    [STRINGID_THUNDERCURRENTISRUNNING]              = COMPOUND_STRING("¡Los truenos azotan el campo de batalla!"),
...
const u16 gStartingStatusStringIds[B_MSG_STARTING_STATUS_COUNT] =
{
    ...
    [B_MSG_TERRAIN_SET_THUNDER]  = STRINGID_TERRAINBECOMESTHUNDER,
...
const u16 gTerrainStringIds[B_MSG_TERRAIN_COUNT] =
{
    ...
    [B_MSG_TERRAIN_END_THUNDER] = STRINGID_THUNDERTERRAINENDS,
};
...
const u16 gTerrainPreventsStringIds[] =
{
    ...
    [B_MSG_TERRAINPREVENTS_THUNDER]  = STRINGID_THUNDERTERRAINPREVENTS,
...
const u8 gText_PkmnIsEvolving[] = _("¡Genial!\n¡{STR_VAR_1} está evolucionando!");
...
const u8 gText_WhatWillPkmnDo2[] = _("¿Y {B_BUFF1}, qué\nhará?");
...
static const u8 sText_TwoTrainersWantToBattle[] = _("¡{B_TRAINER1_CLASS} {B_TRAINER1_NAME} y {B_TRAINER2_CLASS} {B_TRAINER2_NAME} te desafían!\p");
