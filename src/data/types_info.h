...
// estas son efectividades customizadas para Pokémon Bismuto, buffeando tipos débiles y nerfeando tipos fuertes
#define FAE_AT (B_UPDATED_TYPE_MATCHUPS >= GEN_CUSTOM ? X(0.5) : X(1.0))  // Fairy      -> Bug
#define BUG_AT (B_UPDATED_TYPE_MATCHUPS >= GEN_CUSTOM ? X(2.0) : X(0.5))  // Bug        -> Fairy
#define ICE_RS (B_UPDATED_TYPE_MATCHUPS >= GEN_CUSTOM ? X(0.5) : X(1.0))  // X          -> Ice
...
{//                   Defender -->
 //  Attacker           None   Normal Fighting Flying  Poison  Ground   Rock    Bug     Ghost   Steel  Mystery  Fire   Water   Grass  Electric Psychic   Ice   Dragon   Dark   Fairy   Stellar
    ...
    [TYPE_GROUND]   = {______, ______, ______, X(0.0), X(2.0), ______, X(2.0), X(0.5), ______, X(2.0), ______, X(2.0), ______, X(0.5), X(2.0), ______, ICE_RS, ______, ______, ______, ______},
    ...
    [TYPE_BUG]      = {______, ______, X(0.5), X(0.5), PSN_RS, ______, ______, ______, X(0.5), X(0.5), ______, X(0.5), ______, X(2.0), ______, X(2.0), ______, ______, X(2.0), BUG_AT, ______},
    ...
    [TYPE_WATER]    = {______, ______, ______, ______, ______, X(2.0), X(2.0), ______, ______, ______, ______, X(2.0), X(0.5), X(0.5), ______, ______, ICE_RS, X(0.5), ______, ______, ______},
    ...
    [TYPE_DRAGON]   = {______, ______, ______, ______, ______, ______, ______, ______, ______, X(0.5), ______, ______, ______, ______, ______, ______, ICE_RS, X(2.0), ______, X(0.0), ______},
    ...
    [TYPE_FAIRY]    = {______, ______, X(2.0), ______, X(0.5), ______, ______, FAE_AT, ______, X(0.5), ______, X(0.5), ______, ______, ______, ______, ______, X(2.0), X(2.0), ______, ______},
