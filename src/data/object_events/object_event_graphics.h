...
const u32 gFieldEffectObjectPic_DarkGrass[] = INCBIN_U32("graphics/field_effects/pics/dark_grass.4bpp");
...
const u32 gObjectEventPic_BallCatch[] = INCBIN_U32("graphics/object_events/pics/people/ball_catch.4bpp");
